      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          ...
          <p className="mb-4 text-gray-600">
            {t("apartment.notFoundDescription")}
          </p>
      ...
      <div className="container mx-auto py-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
                ...
                toggleFavorite({
                  ...
                  rooms:
                    typeof apartment.rooms === "number"
                      ? apartment.rooms
                      : parseInt(apartment.rooms.toString()),
                  area: apartment.area,
            ...
            >
              <Heart
                className={`h-4 w-4 ${isFavorite(apartmentId) ? "fill-red-500 text-red-500" : ""}`}
              />
            </Button>
          </div>
        </div>
            ...
            <div className="flex gap-3">
              ...
              >
                <DialogTrigger asChild>
                  <Button className="flex-1">{t("apartment.reserve")}</Button>
                </DialogTrigger>
              ...
              {apartment.price && (
                ...
                >
                  ...
                  <DialogContent className="max-w-md">
                    <DialogHeader>
                      <DialogTitle>
                        {t("apartment.installmentCalculator")}
                      </DialogTitle>
                    </DialogHeader>
