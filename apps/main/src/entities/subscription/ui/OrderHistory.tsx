...
export type OrderHistoryFilter = "all" | "paid" | "pending";
...
export const OrderHistory: React.FC<OrderHistoryProps> = ({
  ...
  return (
    <div className="w-full min-w-0 overflow-hidden rounded-lg border border-border/70 bg-white text-card-foreground shadow-[0_1px_2px_hsl(var(--foreground)/0.04)]">
