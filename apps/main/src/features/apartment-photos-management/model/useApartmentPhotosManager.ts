...
export const useApartmentPhotosManager = (projectId: string) => {
  ...
  return {
    ...
    photoUploadInputRef: upload.photoUploadInputRef,
    handlePhotoUpload: upload.handlePhotoUpload,
    handleUploadDrop: upload.handleUploadDrop,
    handleUploadDragOver: upload.handleUploadDragOver,
    handleUploadDragLeave: upload.handleUploadDragLeave,
