...
export const AdminApartmentFilters = ({
  ...
  // --- staged state (applied only on "Apply") ---
  ...
  const [advSearch, setAdvSearch] = useState(searchTerm);
