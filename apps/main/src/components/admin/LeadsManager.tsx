...
export function LeadsManager({
  ...
  const [isFunnelTriggersWarningDismissed, setIsFunnelTriggersWarningDismissed] =
    useState(false);
        ...
        <div className="flex items-center justify-between px-4 md:px-6 h-16 border-b border-slate-200 bg-white shrink-0 sticky top-0 z-20 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-[var(--admin-primary)] hover:bg-[var(--admin-primary-hover)] active:bg-[var(--admin-primary-active)] text-[var(--admin-text-on-primary)] rounded-lg text-sm font-bold transition-colors shadow-sm"
            >
              {t('leads.funnel.save')}
            </button>
          </div>
      ...
      <div className="border-b border-slate-200 bg-white shrink-0 shadow-sm">
        ...
        <div className="hidden lg:flex items-center h-16 px-6 gap-4">
          ...
          <div className="relative shrink-0" ref={funnelMenuRef}>
            ...
            >
              ...
              <ChevronDown
                size={16}
                className={`text-slate-400 group-hover:text-slate-600 transition-transform duration-200 ${isFunnelMenuOpen ? 'rotate-180' : ''
                  }`}
              />
            </button>
            {isFunnelMenuOpen && (
                      ...
                      {editingFunnelId === funnel.id ? (
                        <>
                          <input
                            ...
                            className="flex-1 bg-white border border-[var(--admin-primary)] rounded px-2 py-1 text-sm outline-none"
                            autoFocus
                          />
                          <button
                        ...
                        <>
                          <div className="flex items-center gap-2 flex-1 min-w-0">
                            ...
                            <span
                              ...
                              className={`truncate cursor-pointer ${activeFunnel?.id === funnel.id
          ...
          <div className="flex-1 min-w-0 relative" ref={filterContainerRef}>
            <div className="relative group w-full max-w-3xl">
              <Search
                size={16}
                className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-hover:text-[var(--admin-primary)] transition-colors pointer-events-none"
              />
              <input
                type="text"
                ...
                className="w-full pl-10 pr-10 py-2 bg-slate-100 hover:bg-slate-50 border border-transparent hover:border-slate-200 focus:border-[var(--admin-primary)] focus:bg-white focus:ring-1 focus:ring-[color:var(--admin-primary)] rounded-lg text-sm text-slate-900 placeholder:text-slate-500 outline-none transition-all cursor-pointer font-medium"
              />
              {activeFiltersCount > 0 && (
                <div className="absolute right-2 top-1/2 -translate-y-1/2 bg-[var(--admin-primary)] text-[var(--admin-text-on-primary)] text-[10px] font-bold px-1.5 py-0.5 rounded-md pointer-events-none">
                  {activeFiltersCount}
                </div>
              )}
            </div>
                ...
                <div className="p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-[var(--admin-primary)]"
                    />
                    <span>-</span>
                    <input
                      type="number"
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 border-t border-slate-200">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="px-6 py-2 text-sm font-bold text-[var(--admin-text-on-primary)] bg-[var(--admin-primary)] rounded-lg hover:bg-[var(--admin-primary-hover)] active:bg-[var(--admin-primary-active)] shadow-sm transition-colors"
                    >
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div className="flex items-center p-1 bg-slate-100 rounded-lg border border-slate-200">
              ...
              <button
                ...
                className={`p-1.5 rounded-md transition-all ${viewMode === 'kanban'
                  ? 'bg-white text-[var(--admin-primary)] shadow-sm'
                  : 'text-slate-400 hover:text-slate-600'
                  }`}
            ...
            <button
              ...
              className="bg-[var(--admin-primary)] hover:bg-[var(--admin-primary-hover)] active:bg-[var(--admin-primary-active)] text-[var(--admin-text-on-primary)] px-4 py-2 rounded-lg text-sm font-bold shadow-sm transition-all active:scale-95 flex items-center gap-2"
            >
              <Plus size={18} />
        ...
        {activeFiltersCount > 0 && (
          <div className="flex items-center gap-2 flex-wrap px-4 lg:px-6 pb-3 pt-1 overflow-x-auto no-scrollbar">
            {filters.source !== 'all' && (
              <FilterChip
                label={`${t('leads.filters.source')}: ${SOURCE_OPTIONS.find((o) => o.value === filters.source)?.label
                  }`}
  ...
  return (
    <div className="flex flex-col h-screen animate-in fade-in duration-500 bg-[var(--admin-background)]">
      <CreateLeadModal
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-start gap-2 shrink-0">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-amber-800/70 hover:text-amber-900 hover:bg-amber-100 transition-colors"
      ...
      <Button
        ...
        size="icon"
        onClick={() => setIsCreateModalOpen(true)}
        className="lg:hidden fixed bottom-16 right-2 z-30 w-12 h-12 bg-[var(--admin-primary)] text-[var(--admin-text-on-primary)] rounded-full flex items-center justify-center shadow-lg hover:bg-[var(--admin-primary-hover)] active:bg-[var(--admin-primary-active)] transition-transform hover:scale-105 group"
