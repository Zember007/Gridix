...
const [messageTemplates, setMessageTemplates] = useState<
  MessageTemplateRow[]
>([]);
const [loadingMessageTemplates, setLoadingMessageTemplates] =
  useState(false);
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
            ...
            onMouseEnter={(e) => {
              if (!saving) e.currentTarget.style.backgroundColor = ADMIN_THEME.primaryHover;
            }}
            onMouseLeave={(e) => {
              if (!saving) e.currentTarget.style.backgroundColor = ADMIN_THEME.primary;
            }}
        >
      ...
      <TabsContent value="company">
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t('adminSettings.companyInfoDesc')}</CardDescription>
          </CardHeader>
      ...
      <TabsContent value="billing">
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t('adminSettings.billingInfoDesc')}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('adminSettings.accountInfoDesc')}</CardDescription>
            </CardHeader>
