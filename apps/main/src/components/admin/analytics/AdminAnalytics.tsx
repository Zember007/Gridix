...
export const AdminAnalytics = () => {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const topProjectsRaw = Array.isArray(raw.topProjects)
        ? raw.topProjects
        : [];
      ...
      return {
        ...
        topApartments: topApartmentsRaw.map((p) => {
          const row = p as Record<string, unknown>;
          const apt =
            typeof row.apartment_number === "string"
  ...
  const apartmentStatsChart = [
    {
      name: t("admin.analytics.apartments.available"),
      value: analyticsData.apartmentStats.available,
    },
    {
      name: t("admin.analytics.apartments.sold"),
      value: analyticsData.apartmentStats.sold,
    },
    {
      name: t("admin.analytics.apartments.reserved"),
      value: analyticsData.apartmentStats.reserved,
    },
            ...
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={analyticsData.topApartments}>
                ...
                <XAxis
                  ...
                  height={100}
                  label={{
                    value: t("admin.analytics.apartment"),
                ...
                <Tooltip
                  ...
                  labelFormatter={(label) =>
                    `${t("admin.analytics.apartment")} №${label}`
                  }
                />
                <Legend />
                <Bar
            ...
            <div className="mb-6 grid grid-cols-3 gap-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-green-600">
                  {analyticsData.apartmentStats.available}
                </p>
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-red-600">
                  {analyticsData.apartmentStats.sold}
                </p>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-yellow-600">
                  {analyticsData.apartmentStats.reserved}
                </p>
                <p className="text-sm text-muted-foreground">
