...
export const ListView = ({
  ...
  return (
    <div className="container mx-auto flex h-full grow flex-col py-2 md:px-6">
      <div
        className={cn(
      ...
      >
        ...
        {(project?.has_commercial || project?.has_parking) && (
          ...
          >
            <TabsList
              wrap={false}
              className="no-scrollbar h-auto w-full max-w-full items-stretch rounded-[20px] border border-gray-200 bg-gray-100/80 p-1.5"
            >
              {[
                ...
                <TabsTrigger
                  key={tab.value}
                  className="min-h-10 flex-none rounded-[14px] px-6 py-2 text-sm font-semibold transition-all duration-200 data-[state=active]:bg-white data-[state=active]:shadow-md md:min-w-0 md:flex-1"
                  style={
                            ...
                            <div className="relative ml-[57px] h-full flex-1 overflow-hidden">
                              ...
                              <div
                                ...
                                onScroll={(e) => {
                                  ...
                                  const leftGradient = document.getElementById(
                                    `left-gradient-${apartment.id}`,
                                  );
                                  const rightGradient = document.getElementById(
