      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm duration-200 animate-in fade-in">
        <div className="flex max-h-[90vh] w-full max-w-lg scale-100 transform flex-col overflow-hidden rounded-xl bg-white shadow-2xl transition-all">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="space-y-1">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm outline-none transition-all placeholder:text-gray-400 focus:border-green-500 focus:ring-1 focus:ring-green-500"
                />
              </div>
              ...
              <div className="relative">
                <select className="w-full appearance-none rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 outline-none transition-all focus:border-green-500 focus:ring-1 focus:ring-green-500">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm outline-none transition-all placeholder:text-gray-400 focus:border-green-500 focus:ring-1 focus:ring-green-500 sm:w-1/3"
                />
                <input
                  type="text"
                  placeholder={t("partners.topupCity")}
                  className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm outline-none transition-all placeholder:text-gray-400 focus:border-green-500 focus:ring-1 focus:ring-green-500 sm:w-2/3"
                />
              </div>
              ...
              <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-4">
                <input
                  ...
                  placeholder="VAT No."
                  disabled={hasNoVat}
                  className={`w-full rounded-lg border border-gray-200 px-4 py-3 text-sm outline-none transition-all placeholder:text-gray-400 focus:border-green-500 focus:ring-1 focus:ring-green-500 sm:flex-1 ${
                    hasNoVat ? "bg-gray-100 text-gray-400" : "bg-white"
                  }`}
                />
                <label className="flex cursor-pointer select-none items-center gap-2 py-1 sm:py-0">
                  <div
          ...
          <div className="mt-auto flex shrink-0 items-center justify-between gap-4 border-t border-gray-100 bg-gray-50 p-4 sm:p-5">
            <button
              onClick={() => setView("topup")}
              className="px-2 py-2 text-xs font-bold uppercase tracking-wider text-gray-500 transition-colors hover:text-gray-700"
            >
              {t("partners.cancel")}
            </button>
            <button
              onClick={() => setView("topup")}
              className="rounded bg-[#4CAF50] px-6 py-3 text-xs font-bold uppercase tracking-wide text-white shadow-md transition-all hover:bg-[#43A047] hover:shadow-lg"
            >
              {t("partners.topupAdd")}
            </button>
          </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm duration-200 animate-in fade-in">
      <div className="w-full max-w-lg scale-100 transform overflow-hidden rounded-xl bg-white shadow-xl transition-all">
          ...
          <div>
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 bg-white py-3 pl-8 pr-4 font-medium shadow-sm outline-none transition-all placeholder:text-gray-400 hover:border-gray-300 focus:border-green-500 focus:ring-1 focus:ring-green-500"
              />
            </div>
          </div>
        ...
        <div className="flex items-center justify-between gap-4 border-t border-gray-100 bg-gray-50 p-5">
          ...
          <button className="rounded bg-[#4CAF50] px-8 py-3 text-xs font-bold uppercase tracking-wide text-white shadow-md transition-all hover:bg-[#43A047] hover:shadow-lg">
