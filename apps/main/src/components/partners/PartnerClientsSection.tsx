...
export const PartnerClientsSection: React.FC = () => {
  ...
  return (
    <div className="relative space-y-6 pb-20 duration-500 animate-in fade-in">
      {/* Модалка заметок */}
      {isNoteModalOpen && (
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
        <div className="mb-6 flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <button
            className="flex items-center gap-2 rounded-lg bg-[#1a1a1a] px-5 py-2.5 text-sm font-medium text-white shadow-lg transition-colors hover:bg-black hover:shadow-xl"
        ...
        {filteredClients.map((client) => {
          ...
          return (
            ...
            >
              {/* Чекбокс выбора */}
              <div
                className="group/checkbox absolute bottom-0 left-0 top-0 z-10 flex w-12 cursor-pointer items-center justify-center"
              ...
              <div className="flex flex-col justify-between gap-6 md:pl-8 lg:flex-row lg:items-center">
                ...
                <div className="grid flex-1 grid-cols-1 gap-6 border-t border-slate-100 pl-8 pt-4 sm:grid-cols-2 md:pl-0 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0">
                  <div>
