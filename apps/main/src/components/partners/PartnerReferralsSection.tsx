      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        <div className="border-b border-gray-100 p-5 md:p-6">
          ...
          <div className="flex flex-col gap-3 lg:flex-row">
            <div className="group relative flex flex-1 items-center gap-3 break-all rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 font-mono text-sm text-gray-600">
        ...
        <div className="bg-gray-50/50 px-5 py-3">
          ...
          {showUtmBuilder && (
            <div className="mt-4 grid grid-cols-1 gap-4 pb-2 duration-200 animate-in slide-in-from-top-2 sm:grid-cols-3">
              <div className="relative space-y-1">
                ...
                <input
                  ...
                  list="utm-sources"
                  className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm outline-none transition-all focus:border-blue-500"
                />
      ...
      <div className="flex flex-col items-center justify-between gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:flex-row">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 py-2 pl-10 pr-4 text-sm outline-none transition-all focus:border-black focus:ring-1 focus:ring-black"
          />
        </div>
      </div>
