        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx("div", {
                className:
                  "px-2 py-1 text-xs font-bold text-slate-400 uppercase tracking-wider",
                children: "\u042D\u0442\u0430\u0436",
              }),
              _jsx("div", {
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      showFilters && viewMode !== "map"
        ? _jsx("div", {
            className:
              "px-4 md:px-6 py-3 bg-white border-b border-slate-200 animate-in slide-in-from-top-2",
            children: _jsx("div", {
      ...
      _jsx("div", {
        ...
        children: _jsx("div", {
          ...
          children: !activeWorkspaceId
            ? _jsx("div", {
                className:
                  "bg-white rounded-2xl p-6 border border-slate-200 shadow-sm text-sm text-slate-600",
            ...
            : projectsQuery.isLoading
              ...
              : (filtered ?? []).length === 0
                ...
                : viewMode === "grid"
                  ? _jsx("div", {
                      ...
                      children: filtered.map((p) => {
                        ...
                        return _jsxs(
                          ...
                          {
                            className:
                              "bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden hover:shadow-lg hover:border-slate-300/80 transition-all duration-300 group cursor-pointer",
                            ...
                            children: [
                              ...
                              _jsxs("div", {
                                ...
                                children: [
                                  _jsx("div", {
                                    className:
                                      "font-black text-slate-900 leading-tight line-clamp-2",
                                    children: p.name,
                                  }),
                                  _jsx("div", {
                                    className:
                  ...
                  : _jsx("div", {
                      className:
                        "h-full rounded-xl overflow-hidden bg-white border border-slate-200 shadow-sm",
