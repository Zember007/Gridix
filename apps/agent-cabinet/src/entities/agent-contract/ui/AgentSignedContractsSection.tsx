...
import type { SignedContract } from "../model/types";

interface AgentSignedContractsSectionProps {
        ...
        {props.loading ? (
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {props.contracts.map((contract) => {
              const lang = contract.template_lang
                ? contract.template_lang.toUpperCase()
                : "\u2014";
              return (
                <div
                  key={contract.id}
