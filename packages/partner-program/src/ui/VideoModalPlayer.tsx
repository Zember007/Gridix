...
export const VideoModalPlayer: React.FC<VideoModalPlayerProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[980px] overflow-hidden p-0">
        <div className="border-b border-white/10 bg-gradient-to-br from-slate-950 to-slate-900 p-5 text-white">
        ...
        <div className="p-5">
          ...
          <div className="mt-4 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-slate-200/20 bg-slate-900 px-3 py-2 text-sm font-semibold text-white transition-colors hover:bg-slate-800"
            >
              ...
              {chapters.map((c, idx) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "mb-2 w-full rounded-md border px-3 py-2 text-left transition-colors last:mb-0",
                      isActive
