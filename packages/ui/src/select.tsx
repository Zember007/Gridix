  ...
  return (
    <SelectPrimitive.Portal container={container ?? undefined}>
      <SelectPrimitive.Content
        ref={ref}
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-[110] max-h-96 min-w-[8rem] overflow-auto rounded-md border shadow-md",
          position === "popper" &&
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "scrollbar-thin scrollbar-thumb-rounded-md scrollbar-thumb-border/40 hover:scrollbar-thumb-border/60 overflow-y-auto p-1",
            position === "popper" &&
