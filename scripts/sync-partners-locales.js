...
const MAIN_PARTNERS = (lang) => path.join(ROOT, 'apps/main/src/locales', lang, 'partners.json');
const SHARED_LOCALE = (lang) => path.join(ROOT, 'packages/utils/src/locales/shared', `${lang}.json`);
