        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col justify-center">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-light text-gray-900 dark:text-white mb-6">{title}</h2>
              {subtitle && (
                <p className="text-xl text-gray-600 max-w-[500px] dark:text-gray-300  leading-relaxed">
                  {subtitle}
                </p>
              )}
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="bg-card border shadow-lg rounded-xl p-8 h-full flex flex-col">
                  ...
                  <div className="relative md:mb-6  flex-1">
                    <Quote className="absolute -top-2 -left-2 h-8 w-8 text-primary/20 rotate-180" />
                    <p className="relative z-10 text-[14px] md:text-lg font-medium leading-relaxed">"{testimonial.content}"</p>
                  </div>
