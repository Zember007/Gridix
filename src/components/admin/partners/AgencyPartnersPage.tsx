        ...
        <div className="flex flex-col ">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white font-bold h-11 px-6 shadow-sm flex items-center gap-2"
                    >
            ...
            <div className="flex gap-6 mt-6">
                <button
                    ...
                    className={`pb-3 text-sm font-bold border-b-2 transition-colors flex items-center gap-2 ${activeTab === 'list' ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
                >
                    <LayoutList size={16} /> Список партнеров
                </button>
                <button
                    onClick={() => setActiveTab('conditions')}
                    className={`pb-3 text-sm font-bold border-b-2 transition-colors flex items-center gap-2 ${activeTab === 'conditions' ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
                >
                                        ...
                                        {partners.map(partner => (
                                            ...
                                            >
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center font-bold text-sm ${partner.type === 'agency' ? 'bg-purple-100 text-purple-600' : 'bg-blue-100 text-blue-600'}`}>
                                            ...
                                            <tr>
                                                <td colSpan={6} className="px-6 py-12 text-center">
                                                    <div className="flex flex-col items-center gap-2 text-slate-400">
                                                        ...
                                                        <Button variant="link" onClick={() => setIsInviteModalOpen(true)}>Пригласить первого партнера</Button>
                                                    </div>
                                                </td>
                                            </tr>
                                        )}
