                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-6">
                            ...
                            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                                ...
                                <div className="p-4 space-y-5">
                                    ...
                                    {lead.apartment && (
                                        <div>
                                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wide block mb-1">{t('leads.drawer.apartment')}</label>

                                            <div className="font-medium text-slate-900 text-sm">{lead.apartment}</div>
                                        </div>
                                    )}
                                    <div>
